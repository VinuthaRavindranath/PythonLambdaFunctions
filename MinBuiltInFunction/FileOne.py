...
student=min(students,key=f)
print(student)

'''
Min builtin function with key optional parameter
...
student=min(students,key=lambda x:x[2])
print(student)
...
f =min(products, key=lambda product:product[1])
print(f)